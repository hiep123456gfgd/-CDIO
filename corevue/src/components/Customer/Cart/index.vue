            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                  ...
                  <tbody class="border-0">
                    <tr>
                      <th class="ps-0 py-3 border-light" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="src/assets/assetsshop/img/1.jpg" alt="..." width="70"/></a>
                    ...
                    <tr>
                      <th class="ps-0 py-3 border-0" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="src/assets/assetsshop/img/2.jpg" alt="..." width="70"/></a>
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6">
                    <router-link to="/shop">
                      <div class=" mb-3 mb-md-0 text-md-start"><a class="btn btn-link p-0 text-dark btn-sm" ><i class="fas fa-long-arrow-alt-left me-2"> </i>Continue shopping</a></div>
                    </router-link>
                  </div>
                  <div class="col-md-6">
                    <router-link to="/checkout">
                      <div class="text-md-end"><a class="btn btn-outline-dark btn-sm" >Procceed to checkout<i class="fas fa-long-arrow-alt-right ms-2"></i></a></div>
                    </router-link>
                  </div>
